...
public class AFriendsOutstretchedHand extends AppCompatActivity {

    @SuppressLint({"SetTextI18n", "UseCompatLoadingForDrawables"})
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_afriends_outstretched_hand);
        ...
        CheckByLvlCards checkByLvlCards = new CheckByLvlCards(3,7, 100, 1, 1600, 7, 100, 6, 2360);
        ...
        JutsuCards jutsuCards = new JutsuCards("Ninjutsu", "Skill", 3, "Impact", checkByLvlCards.getCpcost_lvl_2(), checkByLvlCards.getCri_lvl_2(), checkByLvlCards.getPow_lvl_2(), checkByLvlCards.getRt_lvl_2());
