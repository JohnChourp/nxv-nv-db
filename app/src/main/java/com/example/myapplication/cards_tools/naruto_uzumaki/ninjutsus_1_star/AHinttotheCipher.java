...
public class AHinttotheCipher extends AppCompatActivity {

    @SuppressLint({"SetTextI18n", "UseCompatLoadingForDrawables"})
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ahinttothe_cipher);
        ...
        JutsuCards jutsuCards = new JutsuCards("Ninjutsu", "Defense", 3, "Manipulate", checkByLvlCards.getCpcost_lvl_2(), checkByLvlCards.getCri_lvl_2(), checkByLvlCards.getPow_lvl_2(), checkByLvlCards.getRt_lvl_2());
