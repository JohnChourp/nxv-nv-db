package com.example.myapplication.cards_tools.naruto_uzumaki.ninjutsus_3_star;
...
public class AThousandYearsofDeath extends AppCompatActivity {

    @SuppressLint({"SetTextI18n", "UseCompatLoadingForDrawables"})
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_athousand_yearsof_death);
        ...
        CheckByLvlCards checkByLvlCards = new CheckByLvlCards(5,7, 100, 1, 1600, 7, 100, 6, 2360);
        ...
        JutsuCards jutsuCards = new JutsuCards("Ninjutsu", "Attack", 5, "Manipulate", checkByLvlCards.getCpcost_lvl_6(), checkByLvlCards.getCri_lvl_6(), checkByLvlCards.getPow_lvl_6(), checkByLvlCards.getRt_lvl_6());
