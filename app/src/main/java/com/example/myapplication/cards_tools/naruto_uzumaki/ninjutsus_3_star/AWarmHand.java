...
public class AWarmHand extends AppCompatActivity {

    @SuppressLint({"SetTextI18n", "UseCompatLoadingForDrawables"})
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_awarm_hand);
        ...
        CheckByLvlCards checkByLvlCards = new CheckByLvlCards(5,6, 80, 1, 1400, 6, 80, 6, 2160);
        ...
        JutsuCards jutsuCards = new JutsuCards("Ninjutsu", "Defense", 5, "Manipulate", checkByLvlCards.getCpcost_lvl_6(), checkByLvlCards.getCri_lvl_6(), checkByLvlCards.getPow_lvl_6(), checkByLvlCards.getRt_lvl_6());
