...
public class BecauseThatsWhoNarutoIs extends AppCompatActivity {

    @SuppressLint({"SetTextI18n", "UseCompatLoadingForDrawables"})
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_because_thats_who_naruto_is);
        ...
        CheckByLvlCards checkByLvlCards = new CheckByLvlCards(6,3, 80, 1, 2000, 3, 80, 6, 2860);
