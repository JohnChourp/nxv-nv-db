...
public class BecauseYoureMeToo extends AppCompatActivity {

    @SuppressLint({"SetTextI18n", "UseCompatLoadingForDrawables"})
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_because_youre_me_too);
        ...
        CheckByLvlCards checkByLvlCards = new CheckByLvlCards(6,7, 100, 1, 1600, 7, 100, 6, 2360);
        ...
        JutsuCards jutsuCards = new JutsuCards("Ninjutsu", "Utility", 6, "Impact", checkByLvlCards.getCpcost_lvl_8(), checkByLvlCards.getCri_lvl_8(), checkByLvlCards.getPow_lvl_8(), checkByLvlCards.getRt_lvl_8());
