...
public class HaremJutsu extends AppCompatActivity {

    @SuppressLint({"SetTextI18n", "UseCompatLoadingForDrawables"})
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_harem_jutsu);
        ...
        CheckByLvlCards checkByLvlCards = new CheckByLvlCards(6,5, 75, 0, 0, 5, 69, 0, 0);
        ...
        JutsuCards jutsuCards = new JutsuCards("Ninjutsu", "Defense", 6, "Normal", checkByLvlCards.getCpcost_lvl_8(), checkByLvlCards.getCri_lvl_8(), checkByLvlCards.getPow_lvl_8(), checkByLvlCards.getRt_lvl_8());
