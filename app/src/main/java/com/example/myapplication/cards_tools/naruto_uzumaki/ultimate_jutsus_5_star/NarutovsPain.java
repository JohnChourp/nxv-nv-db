...
public class NarutovsPain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckByLvlCards checkByLvlCards = new CheckByLvlCards(6,60, 300, 1, 4000, 60, 300, 6, 4760);
        ...
        JutsuCards jutsuCards = new JutsuCards("Ultimate Jutsu", "Attack", 6, "Release", checkByLvlCards.getCpcost_lvl_8(), checkByLvlCards.getCri_lvl_8(), checkByLvlCards.getPow_lvl_8(), checkByLvlCards.getRt_lvl_8());
